    ...
    <div class="col-lg-9 ps-xl-5">
        ...
        <div class="profile-setting-panel-wrap">
            ...
            <div class="tab-content mt-4" id="myTabContent">
                <div class="tab-pane fade show active" id="offers-receive" role="tabpanel"
                    aria-labelledby="offers-receive-tab">
                            ...
                            <div class="col-xl-6" v-for="item in SectionData.offerData.receiveItems" :key="item.id">
                                <div class="card card-full">
                                    <div class="card-body card-body-s1">
                                        ...
                                        <div class="card-media mb-3">
                                            <div class="card-media-body" v-for="actionList in item.actionList"
                                                :key="actionList.id">
                                        ...
                                        <ul class="btns-group">
                                            <li v-for="list in item.btns" :key="list.id"><a :href="list.path"
                                                    class="btn-link flex-grow-1 fw-medium fs-13"
                                                    :class="list.btnClass">{{ list.title }}</a></li>
                                        </ul>
                                    </div><!-- end card-body -->
                                </div><!-- end card -->
                            </div><!-- end col -->
                            ...
                            <div class="col-xl-6" v-for="item in SectionData.offerData.madeItems" :key="item.id">
                                <div class="card card-full">
                                    <div class="card-body card-body-s1">
                                        ...
                                        <ul class="btns-group">
                                            <li><span class="badge fw-medium" :class="item.badgeClass">{{ item.badgeText
                                            }}</span></li>
                                            <li><a href="#" class="btn-link fw-medium fs-13 text-danger">{{ item.btnText
                                            }}</a></li>
                                        </ul>
                                    </div><!-- end card-body -->
                                </div><!-- end card -->
